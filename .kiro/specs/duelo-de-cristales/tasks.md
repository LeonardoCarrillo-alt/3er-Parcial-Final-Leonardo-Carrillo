...
- [ ] 2. Tipos TypeScript compartidos
  ...
  - [ ] 2.1 Crear `server/src/game/types.ts` con todas las interfaces del backend
  ...
  - [ ] 2.2 Crear `client/src/types/game.ts` como espejo del backend
...
- [ ] 3. Generador del estado inicial (`generator.ts`)
  ...
  - [ ] 3.1 Implementar `createInitialState(player1, player2): GameState`
  ...
  - [ ] 3.2 Posicionar Núcleos y Magos en coordenadas fijas
  ...
  - [ ] 3.3 Algoritmo Fisher-Yates para colocar 8 obstáculos sin colisión
  ...
  - [ ]* 3.8 Escribir property test para el estado inicial (Propiedad 1)
  ...
  - [ ]* 3.9 Escribir property test para el tablero inicial (Propiedad 2)
...
- [ ] 4. Checkpoint — Verificar generación del estado inicial
...
- [ ] 5. Validador de acciones (`validator.ts`)
  ...
  - [ ] 5.1 Implementar `validateAction(state, req): ValidationResult`
  ...
  - [ ] 5.2 Validar que la partida no ha terminado (`status !== "finished"`)
  ...
  - [ ] 5.3 Validar que la acción corresponde al jugador activo
    - Si `req.playerId !== state.turn`, retornar `{ valid: false, error: "No es tu turno" }`.
    - _Requisitos: 3.3, 4.4, 5.4, 6.5_

  - [ ] 5.4 Validar maná suficiente según la acción
  ...
  - [ ] 5.5 Validar límites del tablero para `move` y `spell` (coordenadas 0–9)
  ...
  - [ ] 5.6 Validar casilla destino no bloqueada para `move`
  ...
  - [ ] 5.7 Validar existencia de cristal en casilla del Mago para `collect`
    - Si `board[mage.y][mage.x].type !== "crystal"`, retornar `{ valid: false, error: "No hay cristal en esta casilla" }`.
    - _Requisitos: 5.3_

  - [ ] 5.8 Validar casilla adyacente libre para `summon` (prioridad N > E > S > O)
  ...
  - [ ]* 5.11 Escribir property test — Acción de jugador inactivo siempre rechazada (Propiedad 5)
  ...
  - [ ]* 5.12 Escribir property test — Maná insuficiente rechaza la acción (Propiedad 6)
...
- [ ] 6. Motor de juego (`engine.ts`)
  ...
  - [ ] 6.1 Implementar `applyAction(state, req): GameState` — función principal
  ...
  - [ ] 6.2 Paso 1: Expirar obstáculos temporales (`Bloqueo`)
  ...
  - [ ] 6.3 Paso 2: Evaluar evento aleatorio (10% de probabilidad, 3 tipos)
  ...
  - [ ] 6.4 Paso 3: Spawn de cristal cada 4 turnos
  ...
  - [ ] 6.5 Paso 5a: Acción `move` — desplazar Mago sin consumir maná
    - Actualizar `position` del Mago en `units` y la `position` del `PlayerState` correspondiente. No modificar `mana`.
    - _Requisitos: 4.1_

  - [ ] 6.6 Paso 5b: Acción `collect` — recolectar cristal
  ...
  - [ ] 6.7 Paso 5c: Acción `summon` — crear Minion adyacente
  ...
  - [ ] 6.8 Paso 5d: Acción `spell` — crear Proyectil en la dirección indicada
  ...
  - [ ] 6.9 Paso 5e: Acción `attack` — atacar unidad enemiga adyacente
  ...
  - [ ] 6.10 Paso 5f: Acción `defend` — asignar armadura al Mago
    - Establecer `armor: 2` en el `PlayerState` del jugador activo (reemplaza, no acumula).
    - _Requisitos: 9.1_

  - [ ] 6.11 Paso 6: Mover proyectiles y resolver impactos
  ...
  - [ ] 6.12 Paso 7: Mover Minions hacia el Núcleo enemigo
  ...
  - [ ] 6.13 Paso 8: Verificar condición de victoria o empate
  ...
  - [ ] 6.14 Paso 9: Resetear armadura, registrar en history, cambiar turno, incrementar turnNumber
  ...
  - [ ]* 6.15 Escribir tests unitarios para `engine.ts`
  ...
  - [ ]* 6.16 Escribir property test — Alternancia de turno e incremento de turnNumber (Propiedad 4)
  ...
  - [ ]* 6.17 Escribir property test — Movimiento del Mago sin consumir maná (Propiedad 8)
  ...
  - [ ]* 6.18 Escribir property test — Recolección de cristal (Propiedad 10)
  ...
  - [ ]* 6.19 Escribir property test — Invocación de Minion (Propiedad 11)
  ...
  - [ ]* 6.20 Escribir property test — Daño de ataque con armadura (Propiedad 12)
  ...
  - [ ]* 6.21 Escribir property test — Victoria al destruir Núcleo (Propiedad 13)
  ...
  - [ ]* 6.22 Escribir property test — Victoria/empate al turno 30 (Propiedad 14)
  ...
  - [ ]* 6.23 Escribir property test — Minion reduce distancia Manhattan (Propiedad 15)
...
- [ ] 7. Checkpoint — Verificar lógica de juego completa
...
- [ ] 8. Rutas Express y servidor (`routes/games.ts` + `index.ts`)
  ...
  - [ ] 8.1 Implementar `POST /api/games` — crear partida
  ...
  - [ ] 8.2 Implementar `GET /api/games/:id` — obtener estado
  ...
  - [ ] 8.3 Implementar `POST /api/games/:id/actions` — ejecutar acción
  ...
  - [ ] 8.4 Implementar `GET /api/games/:id/history` — obtener historial
  ...
  - [ ] 8.5 Implementar `server/src/index.ts` — entrada del servidor
  ...
  - [ ]* 8.6 Escribir tests unitarios para `routes/games.ts`
  ...
  - [ ]* 8.7 Escribir property test — Rechazo de nombres inválidos en creación (Propiedad 3)
  ...
  - [ ]* 8.8 Escribir property test — Historial append-only con estructura correcta (Propiedad 7)
...
- [ ] 10. Hook `useGame` y lógica de comunicación del frontend
  ...
  - [ ] 10.1 Implementar `client/src/hooks/useGame.ts` — estado y operaciones
  ...
  - [ ] 10.2 Implementar `createGame(player1, player2)` con `fetch` nativo
  ...
  - [ ] 10.5 Manejo de errores: preservar estado válido ante 4xx/5xx
...
- [ ] 11. Componentes React
  ...
  - [ ] 11.1 Crear `StartScreen.tsx` — pantalla de inicio con validación
  ...
  - [ ] 11.2 Crear `Board.tsx` — cuadrícula 10×10 CSS Grid
  ...
  - [ ] 11.3 Crear `Cell.tsx` — renderizado de casillas con iconos y colores
  ...
  - [ ] 11.4 Crear `Hud.tsx` — HUD permanente con estadísticas
  ...
  - [ ] 11.5 Crear `ActionPanel.tsx` — panel de 6 botones con control de turno
  ...
  - [ ] 11.6 Crear `ResultScreen.tsx` — pantalla de resultado final
  ...
  - [ ] 11.7 Actualizar `App.tsx` — orquestar la navegación entre pantallas
  ...
  - [ ] 11.8 Crear `styles.css` — estilos globales con animaciones CSS
  ...
  - [ ]* 11.9 Escribir property test — Validación del formulario de inicio (Propiedad 16)
  ...
  - [ ]* 11.10 Escribir property test — Panel deshabilita botones del jugador inactivo (Propiedad 17)
...
- [ ] 12. Integración y conexión frontend-backend
  ...
  - [ ] 12.1 Conectar `fetch` al backend real via proxy de Vite
  ...
  - [ ] 12.2 Probar flujo completo de juego manualmente desde el navegador
  ...
  - [ ] 12.3 Verificar animaciones CSS de proyectiles y Minions
    - Confirmar que los proyectiles y Minions muestran transiciones CSS visibles (100–400 ms) al moverse entre casillas.
    - _Requisitos: 16.3, 16.4_

  - [ ] 12.4 Verificar mensajes de error del backend en el frontend
...
- [ ] 13. Tests E2E con Playwright
  ...
  - [ ] 13.1 Instalar Playwright y configurar `playwright.config.ts`
  ...
  - [ ] 13.2 Escribir `tests/e2e/game.spec.ts` con los 12 casos de prueba
  ...
  - [ ] 13.3 Ejecutar E2E en modo headless y verificar que pasan
...
- [ ] 14. Checkpoint — Verificar E2E completo
...
- [ ] 15. GitHub Actions workflows (CI/CD)
  ...
  - [ ] 15.1 Crear `.github/workflows/lint.yml`
  ...
  - [ ] 15.2 Crear `.github/workflows/e2e.yml`
  ...
  - [ ] 15.3 Crear `.github/workflows/deploy.yml`
